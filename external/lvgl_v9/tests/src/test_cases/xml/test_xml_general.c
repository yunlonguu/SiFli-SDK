...
void test_xml_image_and_font(void)
{
    ...
    /* Vendor adaptation: use test-owned cogwheel assets instead of the
     * unavailable demos/render image assets (only used as placeholders). */
    LV_IMAGE_DECLARE(test_image_cogwheel_a8);
    LV_IMAGE_DECLARE(test_image_cogwheel_rgb565);
    lv_xml_register_image(NULL, "test_img1", &test_image_cogwheel_a8);
    lv_xml_register_image(NULL, "test_img2", &test_image_cogwheel_rgb565);
